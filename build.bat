...
REM Copie des niveaux sauvegardés
echo Copie des niveaux sauvegardes...
xcopy /s /y saved_map\* bin\saved_map\
...
cd bin
jar cvfe beyondtime.jar fr.beyondtime.main.Main . saved_map\
cd ..
